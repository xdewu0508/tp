    ...
    public void toModelType_validFlag_returnsPersonWithFlag() throws Exception {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        BENSON.getStudentClass().toString(), null, VALID_FLAG, VALID_TAGS);
    ...
    public void toModelType_invalidFlag_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(ALICE.getName().toString(), ALICE.getPhone().toString(),
                        ...
                        ALICE.getAddress().toString(), ALICE.getStudentClass().toString(), null, INVALID_FLAG,
